...
It contains:
- [a calibration tool](https://github.com/code-iai/iai_kinect2/tree/master/camera_calibration) for calibrating the IR sensor of the Kinect One to the RGB image
